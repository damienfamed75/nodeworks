...
open class ControllerRenderer(context: BlockEntityRendererProvider.Context) :
    ...
    private fun submitCube(
        ...
        submitNodeCollector.submitCustomGeometry(poseStack, renderType) { pose, vc ->
            // +Z
            vc.addVertex(pose, mx, mn, mx).setUv(1f, 1f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, 0f, 0f, 1f)
            vc.addVertex(pose, mx, mx, mx).setUv(1f, 0f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, 0f, 0f, 1f)
            vc.addVertex(pose, mn, mx, mx).setUv(0f, 0f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, 0f, 0f, 1f)
            vc.addVertex(pose, mn, mn, mx).setUv(0f, 1f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, 0f, 0f, 1f)
            // -Z
            vc.addVertex(pose, mn, mn, mn).setUv(1f, 1f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, 0f, 0f, -1f)
            vc.addVertex(pose, mn, mx, mn).setUv(1f, 0f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, 0f, 0f, -1f)
            vc.addVertex(pose, mx, mx, mn).setUv(0f, 0f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, 0f, 0f, -1f)
            vc.addVertex(pose, mx, mn, mn).setUv(0f, 1f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, 0f, 0f, -1f)
            // +X
            vc.addVertex(pose, mx, mn, mn).setUv(1f, 1f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, 1f, 0f, 0f)
            vc.addVertex(pose, mx, mx, mn).setUv(1f, 0f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, 1f, 0f, 0f)
            vc.addVertex(pose, mx, mx, mx).setUv(0f, 0f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, 1f, 0f, 0f)
            vc.addVertex(pose, mx, mn, mx).setUv(0f, 1f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, 1f, 0f, 0f)
            // -X
            vc.addVertex(pose, mn, mn, mx).setUv(1f, 1f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, -1f, 0f, 0f)
            vc.addVertex(pose, mn, mx, mx).setUv(1f, 0f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, -1f, 0f, 0f)
            vc.addVertex(pose, mn, mx, mn).setUv(0f, 0f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, -1f, 0f, 0f)
            vc.addVertex(pose, mn, mn, mn).setUv(0f, 1f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, -1f, 0f, 0f)
            // +Y
            vc.addVertex(pose, mn, mx, mx).setUv(0f, 1f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, 0f, 1f, 0f)
            vc.addVertex(pose, mx, mx, mx).setUv(1f, 1f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, 0f, 1f, 0f)
            vc.addVertex(pose, mx, mx, mn).setUv(1f, 0f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, 0f, 1f, 0f)
            vc.addVertex(pose, mn, mx, mn).setUv(0f, 0f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, 0f, 1f, 0f)
            // -Y
            vc.addVertex(pose, mn, mn, mn).setUv(0f, 0f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, 0f, -1f, 0f)
            vc.addVertex(pose, mx, mn, mn).setUv(1f, 0f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, 0f, -1f, 0f)
            vc.addVertex(pose, mx, mn, mx).setUv(1f, 1f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, 0f, -1f, 0f)
            vc.addVertex(pose, mn, mn, mx).setUv(0f, 1f).setColor(r, g, b, a).setOverlay(overlay).setUv2(RenderUtils.FULL_BRIGHT, RenderUtils.FULL_BRIGHT).setNormal(pose, 0f, -1f, 0f)
        }
    }
}
