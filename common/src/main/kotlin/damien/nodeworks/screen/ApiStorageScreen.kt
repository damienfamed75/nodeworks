...
class ApiStorageScreen(
    menu: ApiStorageScreenHandler,
    playerInventory: Inventory,
    title: Component
) : AbstractContainerScreen<ApiStorageScreenHandler>(menu, playerInventory, title) {
    ...
    override fun renderSlot(graphics: GuiGraphics, slot: Slot) {
        ...
        if (slot.index >= ApiStorageScreenHandler.API_SLOT_COUNT) return
