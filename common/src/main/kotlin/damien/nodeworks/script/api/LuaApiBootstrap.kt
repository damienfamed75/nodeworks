...
object LuaApiBootstrap {
    ...
    private fun register() {
        ...
        LuaApiRegistry.register(WidgetHandleApi)
        LuaApiRegistry.register(DisplayHandleApi)
        LuaApiRegistry.register(DisplayBoxApi)
        LuaApiRegistry.register(DisplayTextApi)
        LuaApiRegistry.register(DisplayLineApi)
        LuaApiRegistry.register(DisplayItemApi)
        LuaApiRegistry.register(DisplayEntityApi)
